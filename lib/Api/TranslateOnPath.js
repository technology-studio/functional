...
const log = new Log('ts-functional.TranslateOnPath')
...
export const translateOnPathIteratorInternal = <VALUE>(
  ...
  if (pathIterator) {
    ...
    if (!pathIteratorResult.done) {
      ...
      const { isTranslateResult, result: subNext } = translateOnPathIteratorInternal(pathIterator, (subPrevious: any) || {}, translate, options)
